...
if (isset($_POST['create']))
{
  ...
  if($cat->create())
  {
    $successmsg="Category created! Assign Admin now";
  }
  else
  {
    $errormsg="Category Not Created";
    // code...
  }
}
//echo "suhas";
         ...
         <div class="card-body">
           ...
           <form method="post">
             ...
             <div class="form-group">
                 ...
                 <textarea class="form-control" name="details" id="exampleFormControlTextarea1" placeholder="details" rows="3" required></textarea>
             </div>
