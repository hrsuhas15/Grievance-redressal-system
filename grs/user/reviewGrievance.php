...
$gre->status="remark";
$stmt=$gre->grievanceRemarked();
$row = $stmt->fetch(PDO::FETCH_ASSOC);
// echo $stmt->rowCount();
// echo $gre->grievanceId;//=$_GET['id'];
// echo $gre->usn;//=$_SESSION['usn'];
// echo $row[status];//"remark";
?>
<!doctype html>
<html lang="en">
<head>
               ...
               <div class="container">
                ...
                <div class="row">
                  <div class="container">
                      ...
                      <div class="row">
                        <div class="col-sm-12">
                         ...
                         <div class="card-header">
                          <h5> Admin Remarks for your Issue </h5>
                         </div>
                         <ul class="list-group list-group-flush">
                           <li class="list-group-item"><?php echo $row[remarks] ?></li>
                         </ul>
                        </div>
                      </div>
                    </div>
                    <div class="container">
                      <div class="row mt">
                                  <label class="col-sm-4 col-sm-4 control-label"><b>Remarked Date :</b></label>
                                    <div class="col-sm-8">
                                    <p><?php echo $row[remarkDate];?></p>
                                    </div>
                      </div>
                    </div>
                    </section>
